...
class Flickr
	API_KEY='10eba05e9699302804b87291fd304e89'
	SHARED_SECRET='c3d8aa316e8b016d'
...
class Flickr::Person
	...
	def self.from_xml(xml,flickr=nil)
		...
		username = cond_text(els,'/user/username')
...
class Flickr::Photo
	attr_accessor :id, :owner_id, :farmid, :secret, :server, :title, :ispublic,
	...
	def url(size=nil)
		base = "http://farm#{farmid}.static.flickr.com"
  ...
  def flickr_url
	...
	def self.from_xml(xml,flickr=nil)
		...
		photo.farmid = att['farm'] if att['farm']
...
class Flickr::PhotoSet < Array
	...
	def fetch(extras=nil, privacy_filter=nil, per_page=50, page=1)
		return self if @fetched
		set = @flickr.photosets.getPhotos(self,extras, per_page, page)
		@fetched = true
		return set
	end
